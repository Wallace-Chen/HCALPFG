...
#                  "/store/data/Run2018C/JetHT/RAW/v1/000/319/756/00001/F447C18D-6A89-E811-A98F-FA163E91A027.root",
#                 "/store/data/Run2018B/JetHT/RAW/v1/000/318/828/00000/FAE1AB55-9F7A-E811-A55D-02163E016035.root",
#                 " /store/data/Run2018B/JetHT/RAW/v1/000/318/828/00000/F8A4CC17-A17A-E811-AB0A-FA163E9240FC.root",
#                 "/store/data/Run2018B/JetHT/RAW/v1/000/317/488/00000/D2C47FC3-4569-E811-88F1-FA163E08DA61.root",
#                  "/store/data/Run2018B/IsolatedBunch/RAW/v1/000/318/828/00000/BAC27998-B17A-E811-AA3E-FA163EB41A13.root",
                  #"/store/data/Run2018B/IsolatedBunch/RAW/v1/000/318/828/00000/1E77E7F9-B07A-E811-BFA2-FA163ECF4EF3.root",
                  #"/store/data/Run2018B/IsolatedBunch/RAW/v1/000/318/828/00000/16589BDB-A67A-E811-ADB4-FA163EF8C830.root",
                  '',
                 VarParsing.VarParsing.multiplicity.list,
                 VarParsing.VarParsing.varType.string,
                 "Input files")

options.inputFiles = '/store/data/Run2018B/IsolatedBunch/RAW/v1/000/318/828/00000/BAC27998-B17A-E811-AA3E-FA163EB41A13.root','/store/data/Run2018B/IsolatedBunch/RAW/v1/000/318/828/00000/1E77E7F9-B07A-E811-BFA2-FA163ECF4EF3.root','/store/data/Run2018B/IsolatedBunch/RAW/v1/000/318/828/00000/16589BDB-A67A-E811-ADB4-FA163EF8C830.root'

options.register('outputFile',
#                 "HcalTupleMaker.root", # default value
                 "results_M0.root", # default value
                 VarParsing.VarParsing.multiplicity.singleton,
                 VarParsing.VarParsing.varType.string,
                 "Output file")
...
process.bunchNumberFilter = cms.EDFilter("BunchNumberFilter",
                                  reverseDecision = cms.bool(False),
                                  bunch_crossing = cms.untracked.string("bx.json"),
                                )
...
#    process.hcalTupleHBHERecHitsMethod0* #M0 RecHit
...
#    process.hcalTupleHBHERecHits*
    ...
    #process.hcalTupleHFRecHits*
#    process.hcalTupleHBHERecHits* #M2 RecHit
...
#    process.recoPath*
    ...
    #process.hfprereco*
    #process.hfreco*
# If meed reco Information, please uncomment the below line    
    process.hbheprereco*
    #process.hbheplan1*
    #process.hbhereco*
    #process.hcalTupleHBHERecHits*
