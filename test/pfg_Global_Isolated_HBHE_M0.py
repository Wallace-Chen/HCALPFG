...
#                 "/store/data/Run2018B/IsolatedBunch/RAW/v1/000/317/279/00000/F8E4C1C9-1A65-E811-BA53-FA163EED2759.root",
                  "/store/data/Run2018D/JetHT/RAW/v1/000/322/118/00000/003A528C-75AF-E811-94EA-02163E01A0AF.root",
...
process.hbheprereco0 = process.hbheprereco.clone(
  algorithm = dict(
    useMahi = cms.bool(False),
    useM2 = cms.bool(False),
    useM3 = cms.bool(False)
  ),
#  hbheInput = cms.InputTag('hbheprereco0'),
)
...
process.hcalTupleHBHERecHitsMethod0.source = cms.untracked.InputTag("hbheprereco0")
...
#process.hcalTupleHBHEDigis.DoEnergyReco = cms.untracked.bool(False)
#process.hcalTupleHFRecHits.source = cms.untracked.InputTag("hfprereco")
